...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ClaudeLi/CLProgressFPD'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'claudeli@yeah.net'}
  s.source           = { :git => 'https://github.com/ClaudeLi/CLProgressFPD.git', :tag => s.version.to_s }
